...
function TelemetrySection() {
  return (
    <section style={{ minHeight: "88vh", display: "flex", alignItems: "center", justifyContent: "center", padding: "80px clamp(14px,4vw,60px)", position: "relative" }}>
      {/* Glow orbs */}
      <div style={{ position: "absolute", top: "10%", right: "5%", width: 400, height: 400, borderRadius: "50%", background: "radial-gradient(circle,rgba(26,108,255,0.08) 0%,transparent 70%)", pointerEvents: "none" }} />
      <div style={{ position: "absolute", bottom: "10%", left: "5%", width: 250, height: 250, borderRadius: "50%", background: "radial-gradient(circle,rgba(232,97,42,0.06) 0%,transparent 70%)", pointerEvents: "none" }} />

      <div style={{ textAlign: "center", maxWidth: 520 }}>
        {/* Chip */}
        <div style={{ display: "inline-flex", alignItems: "center", gap: 8, padding: "5px 14px", background: "rgba(232,97,42,0.1)", border: "1px solid rgba(232,97,42,0.3)", borderRadius: 20, fontFamily: "'Space Mono',monospace", fontSize: 10, letterSpacing: 2, color: "#E8612A", marginBottom: 20 }}>
          <div className="live-dot" style={{ width: 6, height: 6, borderRadius: "50%", background: "#E8612A" }} />
          TELEMETRY LINK OFFLINE
        </div>

        {/* 404 */}
        <div style={{ fontFamily: "'Space Mono',monospace", fontSize: "clamp(60px,10vw,90px)", fontWeight: 700, background: "linear-gradient(135deg,#E8612A,#FF7A42 40%,#FFB800)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", lineHeight: 1, marginBottom: 12 }}>404</div>

        <h2 style={{ fontFamily: "'Syne',sans-serif", fontSize: "clamp(20px,3vw,28px)", fontWeight: 800, color: "#F0F4FF", marginBottom: 14 }}>Signal Not Found<span style={{ color: "#E8612A" }}>.</span></h2>

        <p style={{ fontFamily: "'DM Sans',sans-serif", fontSize: 15, color: "#7A8FAD", lineHeight: 1.8, marginBottom: 32 }}>
          The live telemetry dashboard is under construction. Ground station integration and LoRa data pipeline are being configured. Check back closer to launch — <strong style={{ color: "#F0F4FF" }}>Apr 12, 2026</strong>.
        </p>

        {/* Packet log */}
        <div style={{ background: "#070C18", border: "1px solid #141D30", borderRadius: 8, padding: "12px 16px", fontFamily: "'Space Mono',monospace", fontSize: 11, color: "#27C47A", textAlign: "left", marginBottom: 28 }}>
          <div style={{ opacity: 0.3, marginBottom: 4 }}>[INIT]  LoRa SX1278 @ 433MHz — searching...</div>
          <div style={{ opacity: 0.3, marginBottom: 4 }}>[RX]    Awaiting ground station connection...</div>
          <div>[ERR]   No telemetry stream detected</div>
        </div>
      </div>
    </section>
  );
